...
<section class="dashboard">
   ...
   <div class="box-container" style="direction: rtl;">
       ...
       <?php
          $select_orders = $conn->prepare("SELECT * FROM `brand`");
      ...
      <div class="box">
         ...
         <p><img src="../images/brand/<?php echo $fetch_orders['image']; ?>" alt="logo" style="width: 64px;"></p>
         <!-- overflow-y: scroll; -->
         <p style="height: 400px; text-align: left; font-size: 16px; direction: ltr;"><?= $fetch_orders['subtitle']; ?></p>
