...
<section class="dashboard">
    ...
    <h1 class="heading">
        ...
        |
        <a href="rdashboard.php" style="color: red; text-decoration: underline;">المحجوزة</a>
        |
   ...
   <div class="box-container" style="direction: rtl;">
    ...
    <?php
        $i = 1;
        $select_store_orders = $conn->prepare("SELECT * FROM `store_orders` WHERE payment_status='reservation'"); 
