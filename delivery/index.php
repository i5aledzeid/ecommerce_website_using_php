...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide" style="height: 200px;">
         <div class="image">
            <img src="../images/delivery/download-5.png" alt="" style="height: 100px;">
         </div>
         <div class="content">
            <span>العمل حر 24/7</span>
            <h3 style="font-size: 16px;">تريد العمل كموصل طلبات</h3>
            <a href="../shop.php" class="btn">احجز الآن</a>
         </div>
      </div>

      <div class="swiper-slide slide" style="height: 200px;">
         <div class="image">
            <img src="../images/delivery/download-1.jpg" alt="" style="height: 100px;">
         </div>
         <div class="content">
            <span>مكافأت كل شهر</span>
            <h3 style="font-size: 16px;">تريد العمل كموصل طلبات</h3>
            <a href="../shop.php" class="btn">احجز الآن</a>
         </div>
      </div>
      ...
      <div class="swiper-slide slide" style="height: 200px;">
         <div class="image">
            <img src="../images/delivery/download-4.png" alt="" style="height: 100px;">
         </div>
         <div class="content">
            <span>متابعة العمل اون لاين</span>
            <h3 style="font-size: 16px;">تريد العمل كموصل طلبات</h3>
            <a href="../shop.php" class="btn">احجز الآن</a>
         </div>
      </div>
...
<?php
$select_products = $conn->prepare("SELECT * FROM `deliveries` WHERE id='$delivery_id'");
...
<section class="category">
   ...
   <h1 class="heading">delivery by country</h1>
